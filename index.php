...
<div class="home default-banner" id="home">
	...
	<!-- CAROUSEL WITH LEFT DESCRIPTION -->
	<div class="contaier-outer">
...
<section class="about-us" id="reparation">
	<div class="container">
		<div class="row">
			<!-- SECTION HEAD -->
			<div class="col-md-4">
				<img src="images/reparation.jpg" alt="About Mountain Biking" class="img-responsive img-circle" style=" height: 360px; ">
...
<section class="about-us" id="location">
	<div class="container">
		<div class="row">
			...
			<!-- SECTION BODY -->
			<div class="col-md-4">
				<img src="images/location.jpg" alt="About Mountain Biking" class="img-responsive img-circle">
				</div>
			</div> <!-- /END SECTION BODY -->
		</div>
	</div>
...
<footer class="footer">
	...
	<div class="google-map">
		<div id="gmap"></div>
		<address class="map-container container">
			<div class="row">
				<div class="map-address col-sm-3 col-xs-4">
					<div class="media">
						<div class="media-left">
